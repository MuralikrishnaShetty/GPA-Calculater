...
public class thirdsem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstsub=(EditText) findViewById(R.id.firstsub2);
        secondsub = (EditText) findViewById(R.id.secondsub2);
        thirdsub = (EditText) findViewById(R.id.thirdsub2);
        fourthsub = (EditText) findViewById(R.id.fourthsub2);
        fifthsub = (EditText) findViewById(R.id.fifthsub2);
        sixthsub = (EditText) findViewById(R.id.sixthsub2);
        seventhsub = (EditText) findViewById(R.id.seventhsub2);
        eightsub = (EditText) findViewById(R.id.eightsub2);
        ninthsub=(EditText)findViewById(R.id.ninthsub2);
        r = findViewById(R.id.result4);
