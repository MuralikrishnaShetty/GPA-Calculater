...
public class Iseseventhsem extends AppCompatActivity {
    EditText firstsub,secondsub,thirdsub,fourthsub,fifthsub,sixthsub,seventhsub;
    Button calculate;
    TextView r;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iseseventhsem);
        firstsub=(EditText) findViewById(R.id.firstsub6);
        secondsub = (EditText) findViewById(R.id.secondsub6);
        thirdsub = (EditText) findViewById(R.id.thirdsub6);
        fourthsub = (EditText) findViewById(R.id.fourthsub6);
        fifthsub = (EditText) findViewById(R.id.fifthsub6);
        sixthsub = (EditText) findViewById(R.id.sixthsub6);
        seventhsub = (EditText) findViewById(R.id.seventhsub6

        );


        r = findViewById(R.id.result8);
        calculate=(Button) findViewById(R.id.calculate8);
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double ans;
                ans=(grade*4)+(grade1*4)+(grade2*3)+(grade3*3)+(grade4*3)+(grade5*2)+(grade6*1);
