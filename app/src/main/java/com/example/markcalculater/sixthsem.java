...
public class sixthsem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstsub=(EditText) findViewById(R.id.firstsub5);
        secondsub = (EditText) findViewById(R.id.secondsub5);
        thirdsub = (EditText) findViewById(R.id.thirdsub5);
        fourthsub = (EditText) findViewById(R.id.fourthsub5);
        fifthsub = (EditText) findViewById(R.id.fifthsub5);
        sixthsub = (EditText) findViewById(R.id.sixthsub5);
        seventhsub = (EditText) findViewById(R.id.seventhsub5);
        eightsub = (EditText) findViewById(R.id.eightsub5);

        r = findViewById(R.id.result7);
        calculate=(Button) findViewById(R.id.calculate7);
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double ans;
                ans=(grade*4)+(grade1*4)+(grade2*4)+(grade3*3)+(grade4*3)+(grade5*2)+(grade6*2)+(grade7*2);

                double total=ans/24;
               //r.setText("S:" +grade+grade1+grade2+grade3+grade4+grade5+grade6+grade7);
