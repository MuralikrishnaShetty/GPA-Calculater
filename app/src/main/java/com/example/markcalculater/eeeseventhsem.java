...
public class eeeseventhsem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eeeseventhsem);
        firstsub=(EditText) findViewById(R.id.firstsub8);
        secondsub = (EditText) findViewById(R.id.secondsub8);
        thirdsub = (EditText) findViewById(R.id.thirdsub8);
        fourthsub = (EditText) findViewById(R.id.fourthsub8);
        fifthsub = (EditText) findViewById(R.id.fifthsub8);
        sixthsub = (EditText) findViewById(R.id.sixthsub8);
        seventhsub = (EditText) findViewById(R.id.seventhsub8);
        eightsub = (EditText) findViewById(R.id.eightsub8);

        r = findViewById(R.id.result10);
        calculate=(Button) findViewById(R.id.calculate10);
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double ans;
                ans=(grade*3)+(grade1*3)+(grade2*3)+(grade3*3)+(grade4*3)+(grade5*2)+(grade6*2)+(grade7*1);
