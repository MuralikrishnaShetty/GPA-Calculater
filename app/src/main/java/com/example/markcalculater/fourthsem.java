...
public class fourthsem extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstsub=(EditText) findViewById(R.id.firstsub3);
        secondsub = (EditText) findViewById(R.id.secondsub3);
        thirdsub = (EditText) findViewById(R.id.thirdsub3);
        fourthsub = (EditText) findViewById(R.id.fourthsub3);
        fifthsub = (EditText) findViewById(R.id.fifthsub3);
        sixthsub = (EditText) findViewById(R.id.sixthsub3);
        seventhsub = (EditText) findViewById(R.id.seventhsub3);
        eightsub = (EditText) findViewById(R.id.eightsub3);
        ninthsub=(EditText)findViewById(R.id.ninthsub3);
        r = findViewById(R.id.result5);
        calculate=(Button) findViewById(R.id.calculate5);
        calculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                double ans;
                ans=(grade*3)+(grade1*4)+(grade2*3)+(grade3*3)+(grade4*3)+(grade5*3)+(grade6*2)+(grade7*2)+(grade8*1
                );
