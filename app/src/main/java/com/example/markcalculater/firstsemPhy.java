...
public class firstsemPhy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_firstsem_phy);
        firstsub=(EditText) findViewById(R.id.firstsub);
        secondsub = (EditText) findViewById(R.id.secondsub);
        thirdsub = (EditText) findViewById(R.id.thirdsub);
        fourthsub = (EditText) findViewById(R.id.fourthsub);
        fifthsub = (EditText) findViewById(R.id.fifthsub);
        sixthsub = (EditText) findViewById(R.id.sixthsub);
        seventhsub = (EditText) findViewById(R.id.seventhsub);
        eightsub = (EditText) findViewById(R.id.eightsub);
        r = findViewById(R.id.result2);
